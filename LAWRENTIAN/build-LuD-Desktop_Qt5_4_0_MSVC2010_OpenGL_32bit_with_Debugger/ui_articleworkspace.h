...
public:
    QLabel *label;
    QPushButton *addArticleWorkspace_pushButton;
    ...
    void setupUi(QWidget *articleWorkspace)
    {
        ...
        font.setWeight(75);
        label->setFont(font);
        addArticleWorkspace_pushButton = new QPushButton(articleWorkspace);
        addArticleWorkspace_pushButton->setObjectName(QStringLiteral("addArticleWorkspace_pushButton"));
        addArticleWorkspace_pushButton->setGeometry(QRect(950, 510, 141, 32));
    ...
    void retranslateUi(QWidget *articleWorkspace)
    {
        ...
        addArticleWorkspace_pushButton->setText(QApplication::translate("articleWorkspace", "Add Workspace", 0));
    } // retranslateUi
