...
public:
    ...
    void setupUi(QWidget *employeesWidget)
    {
        ...
        employeesWidget->resize(1036, 600);
        ...
        employeeTable->verticalHeader()->setProperty("showSortIndicator", QVariant(true));
        ...
        approveRegButton->setGeometry(QRect(820, 40, 201, 21));
    ...
    void retranslateUi(QWidget *employeesWidget)
    {
        ...
        approveRegButton->setText(QApplication::translate("employeesWidget", "Approve/Edit Employee", 0));
    } // retranslateUi
