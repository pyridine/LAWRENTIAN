...
void ArticleWorkspaceAAndEWidget::initTextBrowser()
{
...
bool ArticleWorkspaceAAndEWidget::workspaceExists(int id)
{
...
void ArticleWorkspaceAAndEWidget::on_articleTextBrowser_anchorClicked(const QUrl &arg1)
{
