...
void ArticleWorkspaceOpEdWidget::init(articleWorkspace *myParent, Client* c,LoginCredentials* crede)
{
    cred = crede;
    client = c;
    parent = myParent;
    ...
    vector<string> articleTitles = dbController->getArticleTitlesForSectionAndIssue("OPED_SECTION", selectedIssue);
