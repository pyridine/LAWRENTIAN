...
EmployeeTabDBController::EmployeeTabDBController()
{

}

void EmployeeTabDBController::init(Client *c){
    client = c;
}

vector<vector<string>>* EmployeeTabDBController::getRegularEmployeeView(){
...
vector<vector<string>>* EmployeeTabDBController::getPrivilegedEmployeeView(){
...
vector<vector<string>>* EmployeeTabDBController::getFullEmployeeView(){
...
int EmployeeTabDBController::getNumberOfEmployees(){
    QSqlQuery* query = new QSqlQuery();
...
void EmployeeTabDBController::unnaproveEmployee(int luid){
    QSqlQuery* query = new QSqlQuery();
...
void EmployeeTabDBController::approveEmployee(int luid){
    QSqlQuery* query = new QSqlQuery();
