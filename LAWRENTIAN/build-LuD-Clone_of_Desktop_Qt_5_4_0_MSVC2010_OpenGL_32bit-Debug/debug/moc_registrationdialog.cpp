...
#include "../../LuD/registrationdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RegistrationDialog_t, stringdata) + ofs \
...
void *RegistrationDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RegistrationDialog.stringdata))
